...
export default function Footer() {
  ...
  return (
    <>
      <img
        src="/general/line-footer-or.svg"
        alt="line-footer-or"
        ...
        <div className="flex max-xl:mx-2 justify-center justify-items-center max-xl:grid grid-cols-1 max-xl:text-center">
          <div className="basis-1/2 justify-center">
            ...
            <div className="grid place-items-center">
              ...
              <img
                className="mb-[1rem]"
                src="/royal/principal-logo-blank.svg"
                alt="logo-w"
                width="239px"
                height="51px"
              />
            ...
            <div className="max-xl:grid place-items-center xl:pr-16">
              <div className="flex gap-x-6 w-max">
                ...
                <a
                  ...
                  href={`https://api.whatsapp.com/send?phone=${languageData.navigation.whatsApp}&text=¡Hola!%20Necesito%20ayuda%20para%20planificar%20mi%20próximo%20viaje%20a%20México.%20¿Podrían%20orientarme%20sobre%20los%20mejores%20destinos%20y%20actividades%20que%20ofrecen?%20¡Espero%20su%20pronta%20respuesta!`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="/icons/whats/whats-w.svg"
                    alt="icon-whatsapp"
                    width="14px"
                    height="14px"
                  />
              ...
              >
                ...
                {/* LP */}
                <span className="hover:!text-or-100 no-underline text-white">
                  info@{toLower(process.env.NEXT_PUBLIC_NAME_COMPANY)}.com
                </span>
              </a>
              <a
              ...
              >
                <img
                  src="/icons/location/location-w.svg"
                  alt="icon-location"
                  width={11}
                  height={14}
                />
