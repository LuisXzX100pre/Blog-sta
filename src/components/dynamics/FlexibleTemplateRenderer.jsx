...
export default function FlexibleTemplateRenderer({ blogData: propBlogData, lang }) {
  ...
  // 🧠 SISTEMA INTELIGENTE: Detectar automáticamente qué datos usar
  let data = null
  ...
  // 🎯 MAPEO DINÁMICO DE SECCIONES A COMPONENTES
  const getSectionComponentMapping = (targetTemplate) => {
    const mappings = {
      1: {
        // Template 1 - Mapear TODAS las secciones posibles a componentes de Template 1
      ...
      2: {
        ...
        // Mapear secciones de Template 3 a Template 2
      ...
      3: {
        // Template 3 - Mapear TODAS las secciones posibles a componentes de Template 3
        generalClimateInfo: WeatherRecommendations,
        monthlyInfo: InfoByMonth,
        frequentlyAskedQuestions: CurrentQuestions,
        // Mapear secciones de Template 1 a Template 3
        ...
        // Mapear secciones de Template 2 a Template 3
  ...
  // 🎯 FUNCIÓN PARA OBTENER TÍTULO PRINCIPAL EXACTO DEL JSON
  const getMainTitle = () => {
  ...
  // 🎯 FUNCIÓN PARA OBTENER TIPO DE TÍTULO SEGÚN CONTENIDO
  const getTitleType = () => {
  ...
  // 🎯 FUNCIÓN PARA OBTENER TIPO DE SECCIÓN
  ...
  // 🧠 RENDERIZADO DINÁMICO: Renderizar TODAS las secciones disponibles en el JSON
  const renderAllSections = () => {
    const componentMapping = getSectionComponentMapping(targetTemplate)
    const renderedSections = []

    // 🔥 RENDERIZAR INTRODUCCIÓN ESPECIAL PARA TEMPLATE 2
    ...
    // 🔥 RENDERIZAR TODAS LAS SECCIONES DEL JSON
    Object.entries(sections).forEach(([sectionKey, sectionData], index) => {
      ...
      if (Component && sectionData?.data) {
        ...
        // Casos especiales para PlacesToVisit (dividir en dos partes)
        if (Component === PlacesToVisit && targetTemplate === 2) {
          ...
          // Agregar FactBox entre las dos partes si existe
    ...
    // 🔥 AGREGAR SECCIONES ESPECIALES QUE NO ESTÁN EN sections

    // FactBox para Template 2 (si no se agregó ya)
    ...
    // Conclusión final para Template 3
        ...
        <div className="max-w-[68vw] mx-auto px-4 sm:px:6 lg:px-8">
          <div className="flex flex-col justify-center">
            <div className="mt-4 mb-6">
              {/* 🎯 USAR TÍTULO PRINCIPAL EXACTO DEL JSON */}
              <Title title={getMainTitle()} type={getTitleType()} />
            </div>
            <div className="flex flex-col gap-5">
              {/* 🎯 USAR INTRODUCCIÓN EXACTA DEL JSON */}
              ...
              {/* 🧠 RENDERIZADO DINÁMICO: Renderizar TODAS las secciones del JSON */}
